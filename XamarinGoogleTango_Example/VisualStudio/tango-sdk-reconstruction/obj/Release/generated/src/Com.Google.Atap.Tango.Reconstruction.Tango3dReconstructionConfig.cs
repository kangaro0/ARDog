...
namespace Com.Google.Atap.Tango.Reconstruction {
	...
	public partial class Tango3dReconstructionConfig : global::Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.atap.tango.reconstruction']/class[@name='Tango3dReconstructionConfig']/field[@name='GENERATE_COLOR']"
		[Register ("GENERATE_COLOR")]
		public const string GenerateColor = (string) "generate_color";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.atap.tango.reconstruction']/class[@name='Tango3dReconstructionConfig']/field[@name='RECTIFY_DEPTH_IMAGE']"
		[Register ("RECTIFY_DEPTH_IMAGE")]
		public const string RectifyDepthImage = (string) "rectify_depth_image";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.atap.tango.reconstruction']/class[@name='Tango3dReconstructionConfig']/field[@name='RESOLUTION']"
		[Register ("RESOLUTION")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.atap.tango.reconstruction']/class[@name='Tango3dReconstructionConfig']/field[@name='USE_PARALLEL_INTEGRATION']"
		[Register ("USE_PARALLEL_INTEGRATION")]
		public const string UseParallelIntegration = (string) "use_parallel_integration";
