...
namespace Com.Google.Tango.UX {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']"
	[global::Android.Runtime.Register ("com/google/tango/ux/UxExceptionEvent", DoNotGenerateAcw=true)]
	public partial class UxExceptionEvent : global::Java.Lang.Object {


		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='STATUS_DETECTED']"
		[Register ("STATUS_DETECTED")]
		public const int StatusDetected = (int) 1;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='STATUS_RESOLVED']"
		[Register ("STATUS_RESOLVED")]
		public const int StatusResolved = (int) 0;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_COLOR_CAMERA_OVER_EXPOSED']"
		[Register ("TYPE_COLOR_CAMERA_OVER_EXPOSED")]
		public const int TypeColorCameraOverExposed = (int) 13;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_COLOR_CAMERA_UNDER_EXPOSED']"
		[Register ("TYPE_COLOR_CAMERA_UNDER_EXPOSED")]
		public const int TypeColorCameraUnderExposed = (int) 14;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_FEW_DEPTH_POINTS']"
		[Register ("TYPE_FEW_DEPTH_POINTS")]
		public const int TypeFewDepthPoints = (int) 4;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_FEW_FEATURES']"
		[Register ("TYPE_FEW_FEATURES")]
		public const int TypeFewFeatures = (int) 3;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_FISHEYE_CAMERA_OVER_EXPOSED']"
		[Register ("TYPE_FISHEYE_CAMERA_OVER_EXPOSED")]
		public const int TypeFisheyeCameraOverExposed = (int) 11;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_FISHEYE_CAMERA_UNDER_EXPOSED']"
		[Register ("TYPE_FISHEYE_CAMERA_UNDER_EXPOSED")]
		public const int TypeFisheyeCameraUnderExposed = (int) 12;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_HOLD_POSTURE']"
		[Register ("TYPE_HOLD_POSTURE")]
		public const int TypeHoldPosture = (int) 10;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_LYING_ON_SURFACE']"
		[Register ("TYPE_LYING_ON_SURFACE")]
		public const int TypeLyingOnSurface = (int) 5;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_MOTION_TRACK_INVALID']"
		[Register ("TYPE_MOTION_TRACK_INVALID")]
		public const int TypeMotionTrackInvalid = (int) 6;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_MOVING_TOO_FAST']"
		[Register ("TYPE_MOVING_TOO_FAST")]
		public const int TypeMovingTooFast = (int) 2;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_OVER_EXPOSED']"
		[Register ("TYPE_OVER_EXPOSED")]
		[Obsolete ("deprecated")]
		public const int TypeOverExposed = (int) 0;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/field[@name='TYPE_UNDER_EXPOSED']"
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/tango/ux/UxExceptionEvent", ref java_class_handle);
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Google.Tango.UX.UxExceptionEvent __this = global::Java.Lang.Object.GetObject<global::Com.Google.Tango.UX.UxExceptionEvent> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe int Status {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/method[@name='getStatus' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/method[@name='setStatus' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/method[@name='getType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe float Value {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.google.tango.ux']/class[@name='UxExceptionEvent']/method[@name='getValue' and count(parameter)=0]"
