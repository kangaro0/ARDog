...
namespace ARDog {
    ...
    void APP::onTangoServiceConnected(JNIEnv *env, jobject jBinder) {
        TangoErrorType ret = TangoService_setBinder(env, jBinder);
    ...
    void APP::onTextureAvailable(TangoCameraId id) {
    ...
    void APP::onDeviceRotationChanged(int display_rotation) {
        display_rotation_ = display_rotation;
        is_video_overlay_rotation_set_ = false;
    }

    void APP::TangoSetupConfig() {
    ...
    void APP::TangoConnectCallbacks() {
    ...
    void APP::UpdateViewportAndProjectionMatrix() {
    ...
    std::string APP::GetTransformString() {
        std::lock_guard<std::mutex> lock(transform_mutex_);
        return transform_string_;
    }

    std::string APP::GetEventString() {
        std::lock_guard<std::mutex> lock(tango_event_mutex_);
    ...
    void APP::UpdateTransform(const double *transform, double timestamp) {
    ...
    void APP::FormatTransformString() {
